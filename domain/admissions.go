...
// Corresponds to schema: admissions.enquiries
type AdmissionEnquiry struct {
	...
	ClassApplyingFor *string         `json:"class_applying_for,omitempty" db:"class_applying_for"` // Note: Not in schema explicitly, but good practice
	PreviousSchool   *string         `json:"previous_school,omitempty" db:"previous_school"`       // Note: Not in schema explicitly
